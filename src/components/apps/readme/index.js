...
export default class README extends Component {
  onWindowFocus() {
    debugger;
    this._el && this._el.focus(); // So that up and down arrows work off the bat
  }

  render() {
    return (
      <div className="app readme-app intersection-root" ref={ref => (this._el = ref)} tabindex="-1">
        <h3>The Game</h3>
        ...
        <Example entity="*" />
        <p>
          All you need to do to eat a diamond is to move Kye on top of it. Kye can move one square
          at a time in any of the four cardinal directions.
        </p>
        <p>
        ...
        <p>
          ...
          <strong>sentry</strong>. A sentry attempts to push whatever it hits, and then turns
          around.
        </p>
        ...
        <p>
          When a round entity, such as this rocky encounters another round entity, it will attempt
          to slip past it. Square entities cannot slip past anything, and nothing can slip past
          them.
        </p>
        ...
        <p>
          ...
          towards the player, and everything else is pulled towards magnets. Thus, you can use them
          to drag other entities around. Entities which are stuck to a magnet cannot move.
        </p>
        ...
        <p>
          ...
          random direction. If they win, they seek the player. When seeking they are not smart
          enough to choose an unobstructed but indirect route. Monsters move relatively slowly,
          however they are allowed to take an extra turn whenever Kye makes a move, which means that
          while they may give the player some time to think, there's no outrunning them.
        </p>
        <p>
        ...
        <p>
          ...
          edible blocks. Edible blocks cannot be pushed or pulled either. Diamonds are special kind
          of edible block, and follow all the same rules as other edible blocks.
        </p>
        <Example level={['S e[ * S']} replay={[100]} />
        <p>
          <strong>Turners</strong> are a kind of block which will change the direction of any
          rockies or sliders which hit them. They do not change the direction of sentries. They are
          labelled with either an "a" or a "c" to indicate whether they will turn the colliding
          block clockwise or anticlockwise
        </p>
        <Example level={[' a      ', ' >     a', 'a       ', '      a ']} replay={[128]} />
        <p>
          <strong>Timers</strong> are a kind of block which will disappear (permanently) after a
          specified amount of time. A number on them indicates that they are a timer and how much
          time they have remaining. It takes two seconds for a timer to count down one number.
        </p>
        ...
        <p>
          <strong>One Ways</strong> appear on the ground. Monsters, rockies, and sliders cannot
          enter their space at all, and the player can only enter the square from the completely
          open side.
        </p>
        <p>
